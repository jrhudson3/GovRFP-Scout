...
const STATE_PORTALS = [
    ...
    { state: 'Minnesota', abbr: 'MN', flag: '🌲', name: 'MN SWIFT', url: 'https://mn.gov/admin/osp/' },
...
const RFP_DATA = [
    ...
    // ──── MINNESOTA ────
    {
        ...
        title: 'DHS – Early Intensive Developmental and Behavioral Intervention (EIDBI)',
        agency: 'MN Department of Human Services (DHS)',
        category: 'autism',
        tags: ['autism', 'children-family', 'idd'],
        status: 'recurring',
        deadline: 'Rolling DHS enrollment',
        description: 'Minnesota DHS enrolls qualified providers for the EIDBI benefit, offering medically necessary treatment for children and young adults with ASD and related conditions.',
        portalUrl: 'https://mn.gov/dhs/partners-and-providers/news-initiatives-reports-workgroups/long-term-services-and-supports/eidbi/',
        agencyUrl: 'https://mn.gov/dhs/',
        keywords: ['autism', 'EIDBI', 'ABA', 'children', 'Minnesota'],
    },
    {
        id: 'mn-002',
        state: 'Minnesota', abbr: 'MN',
        title: 'Disability Services – HCBS Waiver Providers',
        agency: 'MN DHS Disability Services Division',
        category: 'idd',
        tags: ['idd', 'social-services'],
        status: 'recurring',
        deadline: 'Rolling Provider Certification',
        description: 'DHS seeks enrolled providers for Brain Injury (BI), Community Access for Disability Inclusion (CADI), Community Alternative Care (CAC), and Developmental Disabilities (DD) waivers.',
        portalUrl: 'https://mn.gov/admin/osp/',
        agencyUrl: 'https://mn.gov/dhs/people-we-serve/people-with-disabilities/services/home-community/programs-and-services/hcbs-waivers.jsp',
        keywords: ['IDD', 'HCBS', 'waiver', 'CADI', 'DD waiver', 'Minnesota'],
    },
